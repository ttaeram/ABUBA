핀테크(FinTech)는 "Financial Technology"의 약자로, **금융(Finance)**과 **기술(Technology)**이 결합된 산업 분야를 의미합니다. 쉽게 말해, 금융 서비스를 보다 효율적이고 편리하게 만들기 위해 정보 기술(IT)을 활용하는 것을 핀테크라고 합니다.
